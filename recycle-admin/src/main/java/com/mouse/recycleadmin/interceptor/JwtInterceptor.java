package com.mouse.recycleadmin.interceptor;
...
public class JwtInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            Admin admin = adminService.queryById(Integer.parseInt(uid.asString()));
            if (admin == null) {
        ...
        try {
            ...
            redisUtils.set("admin-id-"+token,uid.asString(),86400);
            return true;
